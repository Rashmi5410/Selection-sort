...
namespace Bme121
{
    static class Program
    {
        ...
        static void SelectSort( int[ ] a, out int [] exchanges )
        {
        ...
        {
            if(a==null) 
            throw new ArgumentOutOfRangeException(nameof (a), "Null." );
            if( a.Length < 2) throw new ArgumentOutOfRangeException( nameof (a), "The array is the wrong size.");
        ...
        static void Main( )
        {
            ...
            SelectSort( data, out int[] exchanges );
            
            WriteLine(); 
            WriteLine("Exchanges array"); 
            WriteArrayOneLine( exchanges, "i", "exch"); 
            
            WriteLine( );
            WriteLine( "Sorted array" );
            WriteArrayOneLine( data, "i", nameof( data ) );
            
            UndoSelectSort( data, exchanges);
